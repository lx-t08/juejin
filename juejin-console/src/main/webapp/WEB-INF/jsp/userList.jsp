		...
		<div class="rt_content">
			...
			<table class="table">
				...
				<tr>
					...
					<td class="center"><img src="${ctx }/static/upload/user_002.png"
				...
				<tr>
					...
					<td class="center"><strong class="rmb_icon">199.00</strong></td>
					<td class="center"><strong class="rmb_icon">15.00</strong></td>
					<td class="center"><a href="user_detail.html" title="编辑"
						class="link_icon">&#101;</a> <a href="#" title="删除"
						class="link_icon">&#100;</a></td>
				</tr>

...
<body>
	...
	<section class="rt_wrap content mCustomScrollbar">
		...
		<div class="rt_content">
			...
			<h1
				style="color: red; font-size: 20px; font-weight: bold; text-align: center;">相关版块涉及样式示例文档（文档说明）</h1>
			<p
				style="color: red; font-size: 16px; font-weight: bold; text-align: center; margin: 8px 0; background: #FFC; padding: 8px;">
				这里是相关常用性样式预设，具体根据内容版块调整，列表添加字段注意考虑笔记本屏幕显示；<br />此页面仅为样式参考，程序对接可移除，具体布局根据项目内容而定<br />注意保留rt_content.parent<br />常用<b
					style="color: #090; text-decoration: underline">“统计图”</b><b
					style="color: #090; text-decoration: underline">“Tab切换”</b><b
					style="color: #090; text-decoration: underline">“加载进度”</b><b
					style="color: #090; text-decoration: underline">“弹窗效果”</b><b
					style="color: #090; text-decoration: underline">“基础按钮及表格布局”</b><b
					style="color: #090; text-decoration: underline">“HTML5canvas特效”</b>等等，具体根据实际需求添加修改追加！
			</p>
			<!--统计图-->
			...
			<section class="pop_bg">
				<div class="pop_cont">
					...
					<div class="pop_cont_input">
						<ul>
							<li><span>标题</span> <input type="text"
			...
			<section>
				...
				<input type="text" class="textbox" placeholder="默认宽度..." /> <input
					...
					placeholder="class=295px..." /> <input type="text"
					class="textbox textbox_225" placeholder="class=225px..." /> <select
					class="select">
					<option>下拉菜单</option>
					<option>菜单1</option>
				</select> <input type="button" value="组合按钮" class="group_btn" />
			</section>
			<section>
				<h2>
			...
			<section>
				...
				<ul class="ulColumn2">
					<li><span class="item_name" style="width: 120px;">商品名称：</span>
						...
						placeholder="文本信息提示..." /> <span class="errorTips">错误提示信息...</span>
					</li>
	...
	<script src="${ctx }/static/js/amcharts.js" type="text/javascript"></script>
	<script src="${ctx }/static/js/serial.js" type="text/javascript"></script>
	<script src="${ctx }/static/js/pie.js" type="text/javascript"></script>
